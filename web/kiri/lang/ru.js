// Русская локализация
self.kiri.lang['ru'] =
self.kiri.lang['ru-ru'] = {
    // common keys and menus
    animate:        "анимацию",      // CAM animate button
    arrange:        "расставить",      // layout workspace objects
    axis:           "ось",         // left object scale pop menu
    clear:          "очистить",        // clear workspace (remove all objects)
    copy:           "копировать",
    delete:         "удалить",
    detail:         "настройки",
    done:           "отмена",
    ...
    help:           "помощь",
    ghost:          "призрак",        // left render pop menu (wireframe)
    hide:           "скрыть",         // left render pop menu (invisible)
    home:           "изначальный",
    import:         "загрузить",
    language:       "язык",
    machine:        "устройства",      // device or machine
    mesh:           "модель",         // mesh editing
    metric:         "metric",
    name:           "имя",
    off:            "выключить",          // turn something off (like a lightbulb)
    on:             "включить",           // turn something on (like a lightbulb)
    prefs:          "программы",        // left menu "preferences"
    preview:        "предпросмотр",
    recent:         "недавние",
    render:         "отображение",       // left render pop menu
    reset:          "сброс",
    rotate:         "поворот",       // left rotate pop menu
    save:           "сохранить",
    scale:          "масштаб",        // left object scale pop menu
    select:         "выбор",
    setup:          "настройки",
    settings:       "настройки",
    size:           "размер",
    slice:          "нарезку",
    solid:          "полное",        // view type pop menu
    start:          "начать",
    tool:           "инструмент",
    tools:          "инструменты",        // CAM tool menu button
    top:            "сверху",
    type:           "тип",         // CAM tool type
    version:        "версия",
    view:           "вид",         // left view pop menu
    wire:           "линии",         // left render pop menu
    volume:         "габариты",       // device build area

    acct_xpo:       ["make a backup of your device","and device profiles with the","option to include workspace","objects and positions"],

    // RIGHT-CLICK CONTEXT MENU
    rc_clws:        "очистить рабочее пространство",
    rc_xpws:        "экспортировать рабочее пространство",
    rc_lafl:        "положить",
    rc_mirr:        "отразить",
    rc_dupl:        "создать копию",
    rc_focs:        "центрировать",
    rc_heal:        "чинить модели",
    rc_swap:        "заменить модель",
    rc_xobj:        "экспортировать OBJ",
    rc_xstl:        "экспортировать STL",
    sb_info:        ["скорость печать","мм/с"],

    // DEVICE MENU and related dialogs
    dm_sldt:        "тип устройства",
    dm_stdd:        "шаблоны",
    dm_mydd:        "мои устройства",
    dm_seld:        "выбранное устройство",
    dm_rcnt:        "недавние файлы",
    dm_savs:        "сохраненные настройки",
    dm_appp:        "Настройки программы",

    // CAM Tool Dialog
    td_tyem:        "end",          // end mill
    td_tybm:        "ball",         // ball mill
    td_tytm:        "taper",        // taper mill
    td_tonm:        "номер инструмента",
    td_shft:        "shaft",        // endmill shaft specs
    td_flut:        "flute",        // endmill flute specs
    td_tapr:        "taper",        // endmill taper specs

    // DEVICE dialog groups
    dv_gr_dev:      "устройство",
    dv_gr_ext:      "экструдер",
    dv_gr_pal:      "palette",
    dv_gr_out:      "вывод",
    dv_gr_gco:      "gcode макросы",

    // DEVICE dialog (_s = label, _l = hover help)
    dv_name_s:      "имя",
    dv_name_l:      "имя устройства",
    dv_fila_s:      "пластик",
    dv_fila_l:      "диаметр в миллиметрах",
    dv_nozl_s:      "сопло",
    dv_nozl_l:      "диаметр в миллиметрах",
    dv_bedw_s:      "ширина",
    dv_bedw_l:      "в стандартной единице измерения",
    dv_bedd_s:      "depth",
    dv_bedd_l:      "в стандартной единице измерения",
    dv_bedh_s:      "высота",
    dv_bedh_l:      ["max build height","в стандартной единице измерения"],
    dv_rezx_s:      "разрешение X",
    dv_rezx_l:      ["разрешение по оси X"],
    dv_rezy_s:      "разрешение Y",
    dv_rezy_l:      ["разрешение по оси Y"],
    dv_zmax_s:      "лимит скорости по Z",
    dv_zmax_l:      ["максимальная скорость по оси Z","в миллиметрах / секунду","0 - без ограничений"],
    dv_time_s:      "множитель времени печати",
    dv_time_l:      ["множитель примерного времени печати в меню экспорта.","увеличивайте или уменьшайте в зависимости от того,","как сильно отличается предполагаемое программой время печати от фактического"],
    dv_spmx_s:      "max spindle",
    dv_spmx_l:      ["max spindle rpm speed","0 to disable"],
    dv_xtab_s:      "абсолютное позиционирование",
    dv_xtab_l:      "extrusion moves absolute",
    dv_orgc_s:      "начало в центре",
    dv_orgc_l:      "начало координат в центре стола",
    // dv_orgt_s:      "origin top",
    // dv_orgt_l:      "part z origin top",
    dv_bedc_s:      "овальный стол",
    dv_bedc_l:      "овальная (или круглая) поверхность для печати",
    dv_belt_s:      "роликовый конвейер",
    dv_belt_l:      "ремневая печатная платформа",
    dv_fsrc_s:      "подача пластика",
    dv_fsrc_l:      ["тип подачи пластика в экструдер"],
    dv_retr_s:      "поддержка втягивания пластика",
    dv_retr_l:      ["прошивка устройства поддерживает команду G10/G11"],
    dv_fanp_s:      "охлаждение",
    dv_fanp_l:      "установить скорость вентилятора",
    dv_feat_s:      "feature",
    dv_feat_l:      "inject code for specified features",
    dv_prog_s:      "прогресс",
    dv_prog_l:      "output on each % progress",
    dv_layr_s:      "слой",
    dv_layr_l:      ["выполняется после каждого слоя"],
    dv_tksp_s:      "разделитель параметров",
    dv_tksp_l:      ["добавлять пробел между","параметрами осей gcode","выкл - G0X0Y0X0","вкл - G0 X0 Y0 Z0"],
    dv_strc_s:      "убирать комментарии",
    dv_strc_l:      ["убирать комментарии из gcode","коментарии начинаются с символа ;"],
    dv_fext_s:      "расширение файла",
    dv_fext_l:      "file name extension",
    dv_lazr_s:      "разрешить лазер",
    dv_lazr_l:      ["разрешить использование лазера"],

    dv_dwll_s:      "задержка",
    dv_dwll_l:      "gcode для приостановки",
    dv_tool_s:      "смена инструмента",
    dv_tool_l:      "gcode для смены инструмента",
    dv_sspd_s:      "spindle speed",
    dv_sspd_l:      "set spindle speed",
    dv_paus_s:      "pause",
    dv_paus_l:      "gcode pause script",
    dv_head_s:      "начало",
    dv_head_l:      "выполняется перед началом печати",
    dv_foot_s:      "конец",
    dv_foot_l:      "выполняется перед окончанием печати",
    dv_pext_s:      "exterior",
    dv_pext_l:      ["gcode script run before","printing exterior lines"],
    dv_pint_s:      "interior",
    dv_pint_l:      ["gcode script run before","printing interior lines"],
    dv_lzon_s:      "включение лазера",
    dv_lzon_l:      "gcode для включения лазера",
    dv_lzof_s:      "выключение лазера",
    dv_lzof_l:      "gcode для отключения лазера",
    dv_exts_s:      "select",
    ...
    dv_exox_s:      "отклонение x",
    dv_exox_l:      "отклонение сопла по оси x",
    dv_exoy_s:      "отклонение y",
    dv_exoy_l:      "отклонение сопла по оси y",

    dv_paid_s:      "printer id",
    dv_paid_l:      ["уникальный идентификатор принтера",""],
    ...
    op_disp:        "отображение",
    op_xprt_s:      "эксперт",
    op_xprt_l:      "показать продвинутые настройки",
    op_decl_s:      "show decals",
    op_decl_l:      "show device decals and logos",
    op_shny_s:      "детализированное",
    op_shny_l:      "использовать более медленный, но более детализированный метод отрисовки. позволяет видеть более мелкие детали на некоторых моделях в угоду производительности",
    op_dang_s:      "эксперементальные",
    op_dang_l:      "показывать эксперементальные параметры",
    op_devl_s:      "разработчик",
    op_devl_l:      ["показывать настройки разработчика"],
    op_hopo_s:      "hover pop",
    op_hopo_l:      ["enable menu hover","to activate"],
    op_dark_s:      "темная тема",
    op_dark_l:      "темный режим интерфейса",
    op_comp_s:      "компактный интерфейс",
    op_comp_l:      ["компактный интерфейс пользователя","для маленьких экранов","и планшетов"],
    op_shor_s:      "начала",
    op_shor_l:      "показывать начала координат и процессов",
    op_shru_s:      "линейки",
    op_shru_l:      ["show axes rulers","on major gridlines"],
    op_sped_s:      "скорость",
    op_sped_l:      ["show speed to color bar","in preview mode"],
    op_auto_s:      "авто расставление",
    op_auto_l:      ["автоматически расставлять добавленные","модели по рабочему пространству"],
    op_free_s:      "свободное перемещение",
    op_free_l:      ["разрешить свободное перемещение объектов по рабочему пространству","в режиме лазера ничего не делает"],
    op_spcr_s:      "отступ",
    op_spcr_l:      ["расстояние между объектами","при автоматическом расставлении моделей","в стандартной единице измерения","чтобы автоматически считать отступ в зависимости от высоты","в режиме роликового конвейера, поставьте 0"],
    op_spcx_s:      "случайный X",
    op_spcx_l:      ["в режиме роликового конвейера","случайно распологать модель по оси X","чтобы выровнять износ ремневого привода"],
    op_orth_s:      "ортогональный",
    op_orth_l:      ["ортогональная проекция","перезагрузите страницу для применения"],
    op_anta_s:      "сглаживание",
    op_anta_l:      ["включить сглаживание","перезагрузите страницу для применения"],
    op_invr_s:      "инвертировать колесо",
    op_invr_l:      ["инвертировать приближение","колесом мыши"],
    op_save_s:      "авто сохранение",
    op_save_l:      ["не очищать рабочее пространство","при перезагрузке страницы"],
    op_line_s:      "line type",
    op_line_l:      ["line style for path rendering","impacts 3d performance","path: 3d best","flat: 2d good","line = 1d fast"],
    op_unit_s:      "стандартная единица измерения",
    op_unit_l:      ["влияет на настройки","скорости и дистанции"],
    op_anim_s:      "animate",
    op_anim_l:      ["animation mesh density","higher is more dense","takes more memory","and is slower"],
    op_exgl_l:      ["показывать устройства Grid:Local в меню экспорта","для принтеров Grid:Bot и устройств, подключенных к OctoPrint"],
    op_exgh_l:      ["устаревшая поддержка Grid:Host в локальной сети"],
    op_exop_l:      ["устаревшая поддержка OctoPrint в локальной сети","рекомендуется плагин Grid:Space OctoPrint"],
    ...
    pt_qual_s:      "детализация",
    pt_qual_l:      ["уровень детализации при нарезке. чем меньше - тем быстрее работает и меньше памяти использует. большие модели зачастую не требуют высокой детализации. понизьте значение если возникают ошибки нехватки памяти."],
    pt_heal_s:      "восстановление модели",
    ...
    pt_thrd_s:      "многопоточность",
    pt_thrd_l:      ["использовать многопоточную нарезку если браузер поддерживает фоновые задачи. повышает использование памяти на больших моделях. отключите если возникают ошибки нехватки памяти."],
    pt_assy_s:      "использовать WASM",
    pt_assy_l:      ["использовать низкоуровневую виртуальную машину, если поддерживается браузером. отключите, если появляются ошибки памяти или артефакты."],
    ...
    ls_lahi_s:      "высота",
    ls_lahi_l:      ["высота слоя","в миллиметрах","0 - автоматическая высота слоя"],
    ls_lahm_s:      "min",
    ls_lahm_l:      ["layer height minimum","will merge auto slices","under this thickness","in millimeters"],
    ls_sngl_s:      "один",
    ls_sngl_l:      ["выполнить нарезку только один раз","с указанной высотой слоя"],
    ...
    cc_sdwn_s:      "step down",
    cc_sdwn_l:      ["step down depth","for each pass","в стандартной единице измерения","0 to disable"],
    cc_thru_s:      "cut thru",
    ...
    cc_feed_s:      "feed rate",
    cc_feed_l:      ["max cutting speed in","ст. ед. изм. / минуту"],
    cc_plng_s:      "plunge rate",
    cc_plng_l:      ["max z axis speed in","ст. ед. изм / минуту"],
    ...
    cc_menu:        "limits",
    cc_rapd_s:      "xy feed",
    cc_rapd_l:      ["max xy moves feedrate","в ст. ед. изм. / минуту"],
    cc_rzpd_s:      "z feed",
    cc_rzpd_l:      ["max z moves feedrate","в ст. ед. изм / минуту"],

    // CNC LEVELING
    cc_loff_s:      "z offset",
    cc_loff_l:      ["distance from stock face","в стандартной единице измерения"],
    cc_lxyo_s:      "xy offset",
    ...
    cr_lsto_l:      ["horizontal offset from vertical faces","stock to leave for finishing pass","в стандартной единице измерения"],
    cr_ease_s:      "ease down",
    ...
    cd_lift_l:      ["lift between plunges","after dwell period","в стандартной единице измерения","0 to disable"],
    cd_regi_s:      "register",
    cd_regi_l:      ["drill registration holes","for double-sided parts","independent of enable","drilling but uses same","tool and settings"],
    cd_thru_s:      "z extend",
    cd_thru_l:      ["extend downward cut through stock","в стандартной единице измерения"],
    cd_mark_s:      "marking",
    ...
    // CNC LASER
    cl_powr_s:      "мощность",
    cl_powr_l:      "мощность лазера от 0 до 1.0",
    cl_adap_s:      "приспосабливающаяся",
    cl_adap_l:      "автоматически подбирать мощность в зависимости от расстояния по оси Z",
    cl_adrp_s:      "repeating",
    ...
    cl_flaz_l:      ["flatten output to this Z height", "в стандартной единице измерения"],
    ...
    ou_powr_s:      "мощность",
    ou_powr_l:      ["0 - 100","в процентах"],
    ou_sped_s:      "скорость",
    ou_sped_l:      "миллиметры / секунду",
    ou_mrgd_s:      "merged",
    ...
    // OUTPUT FDM
    ou_nozl_s:      "температура сопла",
    ou_nozl_l:      "в градусах цельсия",
    ou_bedd_s:      "температура стола",
    ou_bedd_l:      "в градусах цельсия",
    ou_feed_s:      "скорость печати",
    ou_feed_l:      ["максимальная скорость печати","0 - по умолчания","миллиметры / секунду"],
    ...
    ou_move_s:      "скорость движения",
    ou_move_l:      ["скорость движения без печати","millimeters / second","0 = enable G0 moves"],
    ou_shml_s:      "shell factor",
    ou_flml_s:      "solid factor",
    ou_spml_s:      "infill factor",
    ou_exml_l:      ["extrusion multiplier","0.0 - 2.0"],
    ou_fans_s:      "скорость вентилятора",
    ou_fans_l:      "0 - 255",
    ...
    co_menu:        "origin",
    co_offx_s:      "offset x",
    co_offx_l:      ["offset origin along x axis","в стандартной единице измерения"],
    co_offy_s:      "offset y",
    co_offt_l:      ["offset origin along y axis","в стандартной единице измерения"],
    co_offz_s:      "offset z",
    co_offz_l:      ["offset origin along z axis","в стандартной единице измерения"],

    // FDM ADVANCED
    ad_menu:        "расширенные",
    ad_rdst_s:      "дистанция втягивания",
    ad_rdst_l:      ["amount to retract filament","for long moves. in millimeters"],
    ad_rrat_s:      "скорость втягивания",
